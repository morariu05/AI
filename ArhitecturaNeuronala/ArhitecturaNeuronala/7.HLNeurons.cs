...
{
    public partial class HiddenLayersNeurons : Form
    {
        public NeuronalNetwork mainform = new NeuronalNetwork();
        public int indexStrat;
        public int indexNeuronPerStrat;

        public HiddenLayersNeurons(int _indexStrat, int _indexNeuronPerStrat, NeuronalNetwork _mainform)
        {
            ...
            this.Text = "h" + indexStrat.ToString() + "N" + indexNeuronPerStrat.ToString() + " Information";
